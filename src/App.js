...
const tld = '.voter';
const CONTRACT_ADDRESS = '0x03068FD892419a67aC79Af719b7B05Fb728482ae';
const App = () => {
		...
		<div className="App">
			<div className="container">
				...
				<div className="header-container">
					<header>
						<div className="left">
							<p className="title">🐱‍👤 Voting Name Service</p>
				...
				<img src="https://media.giphy.com/media/L0J7ICm4GNzyvs0ZUx/giphy.gif" alt="Ninja gif" style={{  width: "25%", marginLeft: "40%", marginBottom: "30px" }} />
